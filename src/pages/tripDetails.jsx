  ...
  return (
    <Container>
      ...
      <Detail>
        ...
        <DetailContent>
          <DetailContentText>
            보문산 보문대는 대전에서 제일가는 산이지만 그 명성은 성심당보다 못하여 무시받지는 않지만 그래도 나쁘지 않은 산이다. 보문산 보문대는 대전에서 제일가는 산이지만 그 명성은 성심당보다 못하여 무시받지는 않지만 그래도 나쁘지 않은 산이다. 보문산 보문대는 대전에서 제일가는 산이지만 그 명성은 성심당보다 못하여 무시받지는 않지만 그래도 나쁘지 않은 산이다.
          </DetailContentText>
        </DetailContent>
      </Detail>
      <Info>
